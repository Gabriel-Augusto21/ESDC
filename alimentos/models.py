...
class Alimento(models.Model):
    ...
    pb = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    ms = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    ed = models.DecimalField(max_digits=5, decimal_places=2, blank=True, null=True)
    is_active = models.BooleanField(default=True)
